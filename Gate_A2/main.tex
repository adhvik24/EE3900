...
That implies \textbf{the impulse response h(t) should be non zero, $h(t)\ne0$ for $t<0$ for a non casual system}. \label{def}
\end{definition}
...
\begin{lemma}
A Hilbert transformer is a non-causal linear time-invariant filter.
\begin{align}
